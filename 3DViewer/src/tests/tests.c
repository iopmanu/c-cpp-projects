...
START_TEST(parser) {
    ...
    matrix_t correct_vertices = {0};
    s21_create_matrix(8, 4, &correct_vertices);
    correct_vertices.matrix[0][0] = 1;
    correct_vertices.matrix[0][1] = -1;
    correct_vertices.matrix[0][2] = -1;
    correct_vertices.matrix[0][3] = 1;

    correct_vertices.matrix[1][0] = 1;
    correct_vertices.matrix[1][1] = -1;
    correct_vertices.matrix[1][2] = 1;
    correct_vertices.matrix[1][3] = 1;

    correct_vertices.matrix[2][0] = -1;
    correct_vertices.matrix[2][1] = -1;
    correct_vertices.matrix[2][2] = 1;
    correct_vertices.matrix[2][3] = 1;

    correct_vertices.matrix[3][0] = -1;
    correct_vertices.matrix[3][1] = -1;
    correct_vertices.matrix[3][2] = -1;
    correct_vertices.matrix[3][3] = 1;

    correct_vertices.matrix[4][0] = 1;
    correct_vertices.matrix[4][1] = 1;
    correct_vertices.matrix[4][2] = -1;
    correct_vertices.matrix[4][3] = 1;

    correct_vertices.matrix[5][0] = 1;
    correct_vertices.matrix[5][1] = 1;
    correct_vertices.matrix[5][2] = 1;
    correct_vertices.matrix[5][3] = 1;

    correct_vertices.matrix[6][0] = -1;
    correct_vertices.matrix[6][1] = 1;
    correct_vertices.matrix[6][2] = 1;
    correct_vertices.matrix[6][3] = 1;

    correct_vertices.matrix[7][0] = -1;
    correct_vertices.matrix[7][1] = 1;
    correct_vertices.matrix[7][2] = -1;
    correct_vertices.matrix[7][3] = 1;

    for (size_t k = 0; k < model.conf.vertex_quantity; k++) {
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 1; j++) {
                ck_assert_double_eq_tol(model.vertices[k].matrix[i][j],
                                        correct_vertices.matrix[k][i], 5e-1);
            }
        }
    }

    matrix_t correct_surfaces = {0};
    s21_create_matrix(12, 3, &correct_surfaces);

    correct_surfaces.matrix[0][0] = 2;
    correct_surfaces.matrix[0][1] = 3;
    correct_surfaces.matrix[0][2] = 4;

    correct_surfaces.matrix[1][0] = 8;
    correct_surfaces.matrix[1][1] = 7;
    correct_surfaces.matrix[1][2] = 6;

    correct_surfaces.matrix[2][0] = 5;
    correct_surfaces.matrix[2][1] = 6;
    correct_surfaces.matrix[2][2] = 2;

    correct_surfaces.matrix[3][0] = 6;
    correct_surfaces.matrix[3][1] = 7;
    correct_surfaces.matrix[3][2] = 3;

    correct_surfaces.matrix[4][0] = 3;
    correct_surfaces.matrix[4][1] = 7;
    correct_surfaces.matrix[4][2] = 8;

    correct_surfaces.matrix[5][0] = 1;
    correct_surfaces.matrix[5][1] = 4;
    correct_surfaces.matrix[5][2] = 8;

    correct_surfaces.matrix[6][0] = 1;
    correct_surfaces.matrix[6][1] = 2;
    correct_surfaces.matrix[6][2] = 4;

    correct_surfaces.matrix[7][0] = 5;
    correct_surfaces.matrix[7][1] = 8;
    correct_surfaces.matrix[7][2] = 6;

    correct_surfaces.matrix[8][0] = 1;
    correct_surfaces.matrix[8][1] = 5;
    correct_surfaces.matrix[8][2] = 2;

    correct_surfaces.matrix[9][0] = 2;
    correct_surfaces.matrix[9][1] = 6;
    correct_surfaces.matrix[9][2] = 3;

    correct_surfaces.matrix[10][0] = 4;
    correct_surfaces.matrix[10][1] = 3;
    correct_surfaces.matrix[10][2] = 8;

    correct_surfaces.matrix[11][0] = 5;
    correct_surfaces.matrix[11][1] = 1;
    correct_surfaces.matrix[11][2] = 8;

    for (size_t k = 0; k < model.conf.surfaces_quantity; k++) {
        for (size_t i = 0; i < model.surfaces[k].points_quantity; i++) {
            ck_assert_double_eq_tol(model.surfaces[k].vertices_sequence[i],
                                    correct_surfaces.matrix[k][i], 5e-1);
        }
    }

    ck_assert_int_eq(code, SUCCESS_E);

    object_dtor(&model);
    s21_remove_matrix(&correct_vertices);
    s21_remove_matrix(&correct_surfaces);
}
END_TEST

START_TEST(null_file) {
    object model = {0};
    char *filename = NULL;
    enum ERRCODE code = reading_obj_file(filename, &model);

    ck_assert_int_eq(code, NULLPTR_E);
}
END_TEST

START_TEST(incorrect_path) {
    object model = {0};
    char *filename = "hello_i'm_aboba.obj";
    enum ERRCODE code = reading_obj_file(filename, &model);

    ck_assert_int_eq(code, FILEERR);
}
END_TEST

// Affine transformations tests

START_TEST(rotation_xyz) {
    double rotation_angle[3] = {30, 30, 30};
    object model = {0};
    char *filename = "objects/test.obj";
    enum ERRCODE code = reading_obj_file(filename, &model);
    ...
    correct_vertices.matrix[0][0] = 1.683013;
    correct_vertices.matrix[0][1] = -0.225481;
    correct_vertices.matrix[0][2] = -0.341506;
    correct_vertices.matrix[0][3] = 1;

    correct_vertices.matrix[1][0] = 0.683013;
    correct_vertices.matrix[1][1] = -1.091506;
    correct_vertices.matrix[1][2] = 1.158494;
    correct_vertices.matrix[1][3] = 1;

    correct_vertices.matrix[2][0] = -0.816987;
    correct_vertices.matrix[2][1] = -1.524519;
    correct_vertices.matrix[2][2] = -0.091506;
    correct_vertices.matrix[2][3] = 1;

    correct_vertices.matrix[3][0] = 0.183013;
    correct_vertices.matrix[3][1] = -0.658494;
    correct_vertices.matrix[3][2] = -1.591506;
    correct_vertices.matrix[3][3] = 1;

    correct_vertices.matrix[4][0] = 0.816987;
    correct_vertices.matrix[4][1] = 1.524519;
    correct_vertices.matrix[4][2] = 0.091507;
    correct_vertices.matrix[4][3] = 1;

    correct_vertices.matrix[5][0] = -0.183014;
    correct_vertices.matrix[5][1] = 0.658493;
    correct_vertices.matrix[5][2] = 1.591506;
    correct_vertices.matrix[5][3] = 1;

    correct_vertices.matrix[6][0] = -1.683013;
    correct_vertices.matrix[6][1] = 0.225481;
    correct_vertices.matrix[6][2] = 0.341506;
    correct_vertices.matrix[6][3] = 1;

    correct_vertices.matrix[7][0] = -0.683013;
    correct_vertices.matrix[7][1] = 1.091506;
    correct_vertices.matrix[7][2] = -1.158494;
    correct_vertices.matrix[7][3] = 1;

    rotate_frame_model(model.vertices, model.conf.vertex_quantity, rotation_angle);
...
START_TEST(move_xyz) {
    ...
    correct_vertices.matrix[0][0] = 6;
    correct_vertices.matrix[0][1] = 4;
    correct_vertices.matrix[0][2] = 4;
    correct_vertices.matrix[0][3] = 1;

    correct_vertices.matrix[1][0] = 6;
    correct_vertices.matrix[1][1] = 4;
    correct_vertices.matrix[1][2] = 6;
    correct_vertices.matrix[1][3] = 1;

    correct_vertices.matrix[2][0] = 4;
    correct_vertices.matrix[2][1] = 4;
    correct_vertices.matrix[2][2] = 6;
    correct_vertices.matrix[2][3] = 1;

    correct_vertices.matrix[3][0] = 4;
    correct_vertices.matrix[3][1] = 4;
    correct_vertices.matrix[3][2] = 4;
    correct_vertices.matrix[3][3] = 1;

    correct_vertices.matrix[4][0] = 6;
    correct_vertices.matrix[4][1] = 6;
    correct_vertices.matrix[4][2] = 4;
    correct_vertices.matrix[4][3] = 1;

    correct_vertices.matrix[5][0] = 6;
    correct_vertices.matrix[5][1] = 6;
    correct_vertices.matrix[5][2] = 6;
    correct_vertices.matrix[5][3] = 1;

    correct_vertices.matrix[6][0] = 4;
    correct_vertices.matrix[6][1] = 6;
    correct_vertices.matrix[6][2] = 6;
    correct_vertices.matrix[6][3] = 1;

    correct_vertices.matrix[7][0] = 4;
    correct_vertices.matrix[7][1] = 6;
    correct_vertices.matrix[7][2] = 4;
    correct_vertices.matrix[7][3] = 1;

    move_frame_model(model.vertices, model.conf.vertex_quantity, move);
...
START_TEST(scale_xyz) {
    ...
    correct_vertices.matrix[0][0] = 2;
    correct_vertices.matrix[0][1] = -2;
    correct_vertices.matrix[0][2] = -2;
    correct_vertices.matrix[0][3] = 1;

    correct_vertices.matrix[1][0] = 2;
    correct_vertices.matrix[1][1] = -2;
    correct_vertices.matrix[1][2] = 2;
    correct_vertices.matrix[1][3] = 1;

    correct_vertices.matrix[2][0] = -2;
    correct_vertices.matrix[2][1] = -2;
    correct_vertices.matrix[2][2] = 2;
    correct_vertices.matrix[2][3] = 1;

    correct_vertices.matrix[3][0] = -2;
    correct_vertices.matrix[3][1] = -2;
    correct_vertices.matrix[3][2] = -2;
    correct_vertices.matrix[3][3] = 1;

    correct_vertices.matrix[4][0] = 2;
    correct_vertices.matrix[4][1] = 2;
    correct_vertices.matrix[4][2] = -2;
    correct_vertices.matrix[4][3] = 1;

    correct_vertices.matrix[5][0] = 2;
    correct_vertices.matrix[5][1] = 2;
    correct_vertices.matrix[5][2] = 2;
    correct_vertices.matrix[5][3] = 1;

    correct_vertices.matrix[6][0] = -2;
    correct_vertices.matrix[6][1] = 2;
    correct_vertices.matrix[6][2] = 2;
    correct_vertices.matrix[6][3] = 1;

    correct_vertices.matrix[7][0] = -2;
    correct_vertices.matrix[7][1] = 2;
    correct_vertices.matrix[7][2] = -2;
    correct_vertices.matrix[7][3] = 1;

    scale_frame_model(model.vertices, model.conf.vertex_quantity, scale);
...
int main(void) {
    ...
    TCase *tc1_1 = tcase_create("Model");
    SRunner *sr = srunner_create(s1);

    suite_add_tcase(s1, tc1_1);

    tcase_add_test(tc1_1, parser);
    tcase_add_test(tc1_1, null_file);
    tcase_add_test(tc1_1, incorrect_path);

    tcase_add_test(tc1_1, rotation_xyz);
    tcase_add_test(tc1_1, move_xyz);
    tcase_add_test(tc1_1, scale_xyz);
